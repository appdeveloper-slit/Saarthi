...
class _hcp_PersonalinfoState extends State<hcp_Personalinfo> {
  ...
  List<dynamic> languagelist = ['English', 'Hindi', 'Marathi','Gujrati','Kannada','Tamil'];
  ...
  String? profile,
      ...
      birtherror,
      adharcarderror,
      adharcardbackerror,languageerror,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle:
                              Sty().smallText.copyWith(color: Clr().grey),
                          counterText: "",
                        ),
                      ),
                    ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: Sty()
                                    .mediumText
                                    .copyWith(color: addlanguageList.isNotEmpty ? Clr().black : const Color(0xff787882)),
                              ),
                              const Icon(
                                Icons.keyboard_arrow_down,
                                size: 28,
                    ...
                    languageerror == null ? const SizedBox.shrink() : Text(languageerror ?? '',style: Sty().mediumText.copyWith(color: Clr().errorRed)),
                    SizedBox(
                      height: Dim().d20,
                    ),
                    InkWell(
                                ...
                                RichText(
                                  text: TextSpan(
                                      ...
                                      style: Sty().smallText.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: adharPhoto != null ? Clr().black : Clr().dottedColor),
                                      children: [
                                        TextSpan(
                                            text: adharPhoto != null ? '' : ' *',
                                            style: TextStyle(
                              ...
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(
                                      ...
                                      style: Sty().smallText.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: adharbackPhoto != null ? Clr().black : Clr().dottedColor),
                                      children: [
                                        TextSpan(
                                            text: adharbackPhoto != null ? '': ' *',
                                            style: TextStyle(
                              ...
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(
                                      ...
                                      style: Sty().smallText.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: signaturePhoto != null ? Clr().black : Clr().dottedColor),
                                      children: [
                                        TextSpan(
                                            text: signaturePhoto != null ?  '' : ' *',
                                            style: TextStyle(
