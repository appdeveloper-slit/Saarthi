...
class OnlineConsultationpage extends State<OnlineConsultation> {
  late BuildContext ctx;
  String? usertoken;
  TextEditingController complainCtrl = TextEditingController();
  static StreamController<dynamic> controller5 =
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          '${widget.onlineDetails[0]['hcpname'].toString()}',
                          style: Sty()
                              .mediumText
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '₹ ${total ?? widget.onlineDetails[0]['total'].toString()}',
                                style: Sty()
                                    .mediumText
                                    .copyWith(fontWeight: FontWeight.w600),
                              ),
  ...
  void addAppoinment() async {
    FormData body = FormData.fromMap({
      ...
      'discount': discount,
      'total_amount': total ?? widget.onlineDetails[0]['total'],
  ...
  void applyCoupan() async {
    FormData body = FormData.fromMap({
      ...
      'amount': widget.onlineDetails[0]['total'],
    });
    var result = await STM().postWithToken(
    ...
    if (success) {
      setState(() {
        ...
        try {
          discount = double.parse(widget.onlineDetails[0]['total'].toString()) -
              double.parse(result['data'].toString());
        } catch (_) {
          discount = int.parse(widget.onlineDetails[0]['total'].toString()) -
