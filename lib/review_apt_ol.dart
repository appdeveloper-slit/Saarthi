...
class OnlineConsultation extends StatefulWidget {
  ...
  const OnlineConsultation({super.key,this.onlineDetails});
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: Dim().d56,
                      backgroundImage: NetworkImage(widget.onlineDetails[0]['hcpprofilepic'].toString()),
                    ),
                    SizedBox(
                      width: 20,
                    ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              widget.onlineDetails[0]['bookingtime'].toString(),
                              style: Sty().mediumText.copyWith(
                                  color: Clr().white,
                                  fontWeight: FontWeight.w600),
                            ),
                            ...
                            Text(
                              DateFormat('d MMM y').format(DateTime.parse(widget.onlineDetails[0]['bookingdate'].toString())),
                              style: Sty().mediumText.copyWith(
                                  color: Clr().white,
                                  fontWeight: FontWeight.w600),
                            )
...
void addAppoinment()async {
    ...
    'booking_date': DateFormat('yyyy-MM-dd').format(DateTime.parse(widget.onlineDetails[0]['bookingdate'].toString())),
    'address': '',
    'contact_number': '',
    'appointment_type': 1,
